  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative bg-navy-gradient text-white overflow-hidden">
        ...
        />
        <div className="absolute -top-24 -right-24 w-96 h-96 rounded-full border-[48px] border-white/4 pointer-events-none" />
      ...
      <div className="relative bg-base-200 py-16 overflow-hidden">
        <div className="absolute top-0 left-0 right-0 h-1 bg-tribar" />
        <div className="absolute -bottom-16 -right-16 w-64 h-64 rounded-full border-[32px] border-accent/8 pointer-events-none" />
